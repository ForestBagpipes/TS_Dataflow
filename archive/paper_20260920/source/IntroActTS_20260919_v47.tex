...
sources of different scale apart. \ph{RECON_READING}. Table~\ref{tab:heterogeneity} carries
...
\resizebox{\textwidth}{!}{\begin{tabular}{lcccc}
    ...
    \midrule
    \textsc{Keep} $a_0$ & \ph{HET_KEEP_BEST} & \ph{HET_KEEP_N} & \ph{HET_KEEP_POS} & \ph{HET_KEEP_UTIL} \\
    \textsc{Ffill} & \ph{HET_FFILL_BEST} & \ph{HET_FFILL_N} & \ph{HET_FFILL_POS} & \ph{HET_FFILL_UTIL} \\
    \textsc{Single TS-ICL} & \ph{HET_SINGLE_BEST} & \ph{HET_SINGLE_N} & \ph{HET_SINGLE_POS} & \ph{HET_SINGLE_UTIL} \\
    \textsc{Multi TS-ICL} & \ph{HET_MULTI_BEST} & \ph{HET_MULTI_N} & \ph{HET_MULTI_POS} & \ph{HET_MULTI_UTIL} \\
    \textsc{Context Ridge} & \ph{HET_RIDGE_BEST} & \ph{HET_RIDGE_N} & \ph{HET_RIDGE_POS} & \ph{HET_RIDGE_UTIL} \\
    \textsc{SAITS} & \ph{HET_SAITS_BEST} & \ph{HET_SAITS_N} & \ph{HET_SAITS_POS} & \ph{HET_SAITS_UTIL} \\
    \bottomrule
  \end{tabular}}
  \vspace{-2pt}
...
\resizebox{\textwidth}{!}{\begin{tabular}{lccccccccc}
    ...
    \midrule
    1 (closest) & \ph{TR_BOLT_B1_DIST} & \ph{TR_BOLT_B1_ERR} & \ph{TR_BOLT_B1_SIGN} & \ph{TR_TF_B1_DIST} & \ph{TR_TF_B1_ERR} & \ph{TR_TF_B1_SIGN} & \ph{TR_CH2_B1_DIST} & \ph{TR_CH2_B1_ERR} & \ph{TR_CH2_B1_SIGN} \\
    2 & \ph{TR_BOLT_B2_DIST} & \ph{TR_BOLT_B2_ERR} & \ph{TR_BOLT_B2_SIGN} & \ph{TR_TF_B2_DIST} & \ph{TR_TF_B2_ERR} & \ph{TR_TF_B2_SIGN} & \ph{TR_CH2_B2_DIST} & \ph{TR_CH2_B2_ERR} & \ph{TR_CH2_B2_SIGN} \\
    3 & \ph{TR_BOLT_B3_DIST} & \ph{TR_BOLT_B3_ERR} & \ph{TR_BOLT_B3_SIGN} & \ph{TR_TF_B3_DIST} & \ph{TR_TF_B3_ERR} & \ph{TR_TF_B3_SIGN} & \ph{TR_CH2_B3_DIST} & \ph{TR_CH2_B3_ERR} & \ph{TR_CH2_B3_SIGN} \\
    4 & \ph{TR_BOLT_B4_DIST} & \ph{TR_BOLT_B4_ERR} & \ph{TR_BOLT_B4_SIGN} & \ph{TR_TF_B4_DIST} & \ph{TR_TF_B4_ERR} & \ph{TR_TF_B4_SIGN} & \ph{TR_CH2_B4_DIST} & \ph{TR_CH2_B4_ERR} & \ph{TR_CH2_B4_SIGN} \\
    5 (furthest) & \ph{TR_BOLT_B5_DIST} & \ph{TR_BOLT_B5_ERR} & \ph{TR_BOLT_B5_SIGN} & \ph{TR_TF_B5_DIST} & \ph{TR_TF_B5_ERR} & \ph{TR_TF_B5_SIGN} & \ph{TR_CH2_B5_DIST} & \ph{TR_CH2_B5_ERR} & \ph{TR_CH2_B5_SIGN} \\
    \midrule
    Rank corr.\ of distance with error & \multicolumn{3}{c}{\ph{TR_BOLT_RHO}} & \multicolumn{3}{c}{\ph{TR_TF_RHO}} & \multicolumn{3}{c}{\ph{TR_CH2_RHO}} \\
    \bottomrule
  \end{tabular}}
\end{table}
...
\begin{tabular}{@{}p{0.17\textwidth} p{0.26\textwidth} p{0.47\textwidth}@{}}
    ...
    \midrule
    Fixed SAITS, deployment model & one per source, on every bank parent & the packaged implementation, two layers, model width 128, four heads, feed-forward width 128, dropout $0.1$, batch size 16, at most \ph{SAITS_EPOCHS} epochs with early stopping. Sources with more than \ph{SAITS_MAXCH} channels use the target channel plus the covariates most correlated with it on TRAIN \\
    ...
    TATO & one pipeline per source and backbone & the official implementation over its eight transformation slots, \ph{TATO_TRIALS} trials seeded with the identity pipeline, each scored by the mean absolute error against the realised futures of \ph{TATO_WINDOWS} TRAIN windows. Gaps are filled by linear interpolation first, which the official pipeline requires, and that step is part of what the row measures \\
    \bottomrule
  \end{tabular}
\end{table}
