...
\resizebox{\textwidth}{!}{\begin{tabular}{lccccc}
    ...
    Method & MASE $\downarrow$ & MSE $\downarrow$ & MAE $\downarrow$ & RMSE $\downarrow$ & Rank $\downarrow$ \\
    \midrule
    \textsc{Native Keep} & 1.794 & \ph{SEV30-KEEP-MSE} & \ph{SEV30-KEEP-MAE} & \ph{SEV30-KEEP-RMSE} & \ph{SEV30-KEEP-RANK} \\
    \textsc{Best Fixed} & 1.483 & \ph{SEV30-BF-MSE} & \ph{SEV30-BF-MAE} & \ph{SEV30-BF-RMSE} & \ph{SEV30-BF-RANK} \\
    R2-CART & 1.469 & \ph{SEV30-R2-MSE} & \ph{SEV30-R2-MAE} & \ph{SEV30-R2-RMSE} & \ph{SEV30-R2-RANK} \\
    ...
    \midrule
    \rowcolor{bestgray}\introact{} & 1.475 & \ph{SEV30-OURS-MSE} & \ph{SEV30-OURS-MAE} & \ph{SEV30-OURS-RMSE} & \ph{SEV30-OURS-RANK} \\
    \bottomrule
  \end{tabular}}
\end{table}
...
\resizebox{\textwidth}{!}{\begin{tabular}{lccccc}
    ...
    Method & MASE $\downarrow$ & MSE $\downarrow$ & MAE $\downarrow$ & RMSE $\downarrow$ & Rank $\downarrow$ \\
    \midrule
    \textsc{Native Keep} & 1.875 & \ph{SEV50-KEEP-MSE} & \ph{SEV50-KEEP-MAE} & \ph{SEV50-KEEP-RMSE} & \ph{SEV50-KEEP-RANK} \\
    \textsc{Best Fixed} & 1.605 & \ph{SEV50-BF-MSE} & \ph{SEV50-BF-MAE} & \ph{SEV50-BF-RMSE} & \ph{SEV50-BF-RANK} \\
    R2-CART & 1.763 & \ph{SEV50-R2-MSE} & \ph{SEV50-R2-MAE} & \ph{SEV50-R2-RMSE} & \ph{SEV50-R2-RANK} \\
    ...
    \midrule
    \rowcolor{bestgray}\introact{} & 1.561 & \ph{SEV50-OURS-MSE} & \ph{SEV50-OURS-MAE} & \ph{SEV50-OURS-RMSE} & \ph{SEV50-OURS-RANK} \\
    \bottomrule
  \end{tabular}}
\end{table}
...
\resizebox{\textwidth}{!}{\begin{tabular}{lcccc}
    ...
    \midrule
    Native KEEP        & 1.576    & 1.794    & 1.875    & \ph{RB_KEEP_WORST} \\
    Best Fixed         & 1.438      & 1.483      & 1.605      & \ph{RB_BF_WORST} \\
    R2-CART            & 1.456      & 1.469      & 1.763      & \ph{RB_R2_WORST} \\
    ...
    \midrule
    \rowcolor{bestgray}\introact{} & 1.447 & 1.475 & 1.561 & \ph{RB_OURS_WORST} \\
    \bottomrule
  \end{tabular}}
\end{table}
