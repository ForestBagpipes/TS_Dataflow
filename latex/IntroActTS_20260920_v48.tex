% Editorial v48. Recorded v47 post-hoc evaluation.
...
Table~\ref{tab:heterogeneity} reports oracle-best shares from $11.1\%$ to $24.8\%$, with
...
\label{sec:exp-harm}
Figure~\ref{fig:harm} reports intervention frequency and harmful loss at the default
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{figure/fig3_intervention_harm.eps}
  \caption{Intervention frequency and harmful loss at $10\%$ missingness, averaged over the three backbones. Bars reproduce the recorded table values. Harmful loss measures the loss added by harmful interventions under the convention in Appendix~\ref{app:diagnostic-conventions}. Values are descriptive aggregates without uncertainty bars.}
  \label{fig:harm}
\end{figure}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{figure/fig4_missingness_severity.eps}
  \caption{Forecasting error across the registered missingness severities. Each point reproduces the source-macro MASE averaged over three backbones, two horizons and four patterns. Configurations are unchanged across levels. All three levels occur in replay construction. Full numerical results are retained in Appendix~\ref{app:severity-full}.}
  \label{fig:robust}
\end{figure}

\subsection{Ablation and Cost}
\label{sec:exp-ablation}
Table~\ref{tab:ablation} compares selector variants using the same catalog prediction cache.
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.75\textwidth]{figure/fig5_rank_agreement.eps}
