...
同一156 dev / 26 parent 的五臂780请求已经完成；包括接口小例在内，共370次去重真实模型推断，原始进程71.4914秒。原生NaN/H96/H192 GPU小例通过；完整原始输出与统一评分独立复核通过，结果来源为 `results/v431/20260914-sprint/timesfm/baseline_table.json`。

| 固定方法 | source宏MASE | 包括治理与预测的估计秒数 |
|---|---:|---:|
| native KEEP | 1.139837392 | 0.200703 |
| FFILL | 1.181309124 | 0.200212 |
| 单变量 TS-ICL | 1.096135338 | 0.230020 |
| 协变量 TS-ICL | 1.136582593 | 0.234099 |
