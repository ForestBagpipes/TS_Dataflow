...
#: The six legal actions. Order is frozen because it defines the argmax
...
#: The first 80% of chronological TRAIN parents form the replay bank; LOPO is
#: performed inside that bank. The final 20% is a separate TRAIN-eval block.
SPLIT_RATIOS = (0.80, 0.20)
SPLIT_NAMES = ("bank", "train_eval")
...
#: Inference batching was admitted only after a TRAIN-context-only numerical
#: equivalence probe.  Bolt exceeded its predeclared tolerance at batch 32 and
#: therefore remains single-series.  TimesFM and Chronos-2 passed at batch 32.
INFERENCE_BATCH_SIZE = {"bolt": 1, "timesfm": 32, "chronos2": 32}
